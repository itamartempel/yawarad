...
//
// API "yawarad": cluster TestHelpers
//
// Command:
// $ goagen
...
// ListClusterOK runs the method List of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ListClusterOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ClusterController, clusterName *string, clusterType *string, limit int, skip *int) (http.ResponseWriter, *app.CountableCollectionClusterForBranching) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	listCtx, _err := app.NewListClusterContext(goaCtx, req, service)
	if _err != nil {
...
// ShowClusterNotFound runs the method Show of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ShowClusterNotFound(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ClusterController, clusterName string) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "ClusterTest"), rw, req, prms)
	showCtx, _err := app.NewShowClusterContext(goaCtx, req, service)
	if _err != nil {
		e, ok := _err.(goa.ServiceError)
		if !ok {
			panic("invalid test data " + _err.Error()) // bug
...
// ShowClusterOK runs the method Show of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ShowClusterOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ClusterController, clusterName string) (http.ResponseWriter, *app.ClusterForBranching) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
